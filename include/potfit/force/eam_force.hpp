...
//   entries density   — g_i(r)     electron density contributed by a type-i
//   atom, ntypes entries embedding — F_i(ρ)     cohesive energy at density ρ
//   for a type-i atom, ntypes entries
