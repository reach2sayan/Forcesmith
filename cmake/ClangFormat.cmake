...
# Toggle with -DFORCESMITH_CLANG_FORMAT=OFF to skip creating the targets entirely.
option(FORCESMITH_CLANG_FORMAT "Provide 'format' / 'format-check' clang-format targets" ON)
find_program(CLANG_FORMAT_EXE NAMES clang-format clang-format-18 clang-format-17)
if (FORCESMITH_CLANG_FORMAT AND CLANG_FORMAT_EXE)
    file(GLOB_RECURSE FORCESMITH_FORMAT_FILES CONFIGURE_DEPENDS
    ...
    add_custom_target(format
            COMMAND ${CLANG_FORMAT_EXE} -i --style=file ${FORCESMITH_FORMAT_FILES}
    ...
    add_custom_target(format-check
            COMMAND ${CLANG_FORMAT_EXE} --style=file --dry-run -Werror ${FORCESMITH_FORMAT_FILES}
            WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
            COMMENT "Checking formatting with ${CLANG_FORMAT_EXE} (no files changed)"
            VERBATIM
    )
elseif (FORCESMITH_CLANG_FORMAT)
