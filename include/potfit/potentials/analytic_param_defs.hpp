...
//                                token        value     min       max
#define POTFIT_APD_lj(X)                                                       \
  X(epsilon, 0.1, 0.0, 1.0)                                                    \
  X(sigma, 2.5, 1.0, 4.0)
#define POTFIT_APD_morse(X)                                                    \
  X(De, 0.1, 0.0, 1.0)                                                         \
  X(a, 2.0, 1.0, 5.0)                                                          \
  X(re, 2.5, 1.0, 5.0)
#define POTFIT_APD_buckingham(X)                                               \
  X(A, 1.0, -10.0, 10.0)                                                       \
  X(rho, 1.0, -10.0, 10.0)                                                     \
  X(C, 1.0, -10.0, 10.0)
#define POTFIT_APD_born(X)                                                     \
  X(A, 0.1, 0.0, 10.0)                                                         \
  X(B, 2.0, 0.0, 10.0)                                                         \
  X(C, 3.0, 0.0, 10.0)                                                         \
  X(D, 2.0, 0.0, 10.0)                                                         \
  X(E, 2.5, 1.0, 8.0)
#define POTFIT_APD_power_decay(X)                                              \
  X(A, 1.0, 0.1, 10.0)                                                         \
  X(n, 2.0, 1.0, 5.0)
#define POTFIT_APD_exp_decay(X)                                                \
  X(A, 4.0, 1.0, 20.0)                                                         \
  X(B, 1.0, 0.5, 5.0)
#define POTFIT_APD_mexp_decay(X)                                               \
  X(A, 0.1, 0.0, 10.0)                                                         \
  X(B, 0.1, 0.0, 10.0)                                                         \
  X(r0, 2.0, 0.0, 10.0)
#define POTFIT_APD_harmonic(X)                                                 \
  X(k, 0.1, 0.0, 10.0)                                                         \
  X(r0, 2.0, 0.0, 8.0)
#define POTFIT_APD_universal(X)                                                \
  X(E0, 1.0, -10.0, 10.0)                                                      \
  X(a, 1.0, 0.0, 20.0)                                                         \
  X(b, 2.0, 0.0, 20.0)                                                         \
  X(c, 0.0, -1.0, 1.0)
#define POTFIT_APD_eopp(X)                                                     \
  ...
  X(k, 2.5, 0.0, 6.0)                                                          \
  X(phi, 3.0, 0.0, 6.3)
#define POTFIT_APD_sqrt(X)                                                     \
  X(A, 0.1, 0.0, 10.0)                                                         \
  X(B, 2.0, 0.0, 10.0)
#define POTFIT_APD_const(X) X(C, 1.0, 0.0, 2.0)
#define POTFIT_APD_parabola(X)                                                 \
  X(A, 1.0, -10.0, 10.0)                                                       \
  X(B, 1.0, -10.0, 10.0)                                                       \
  X(C, 1.0, -10.0, 10.0)
#define POTFIT_APD_softshell(X)                                                \
  X(A, 1.0, 0.1, 10.0)                                                         \
  X(n, 2.0, 1.0, 5.0)
...
//   POTFIT_PARAM_NAME_LIST(POTFIT_APD_lj)  →  std::vector<std::string>{
//   "epsilon", "sigma", }
