...
#include "forcesmith/core/radial_potential.hpp" // NoParamJacobian
...
public:
  ...
  // Fused eval_at/deriv_at; each expression copied verbatim, so bit-identical.
